...
ALTER TABLE campaigns
  ...
  CHECK (platform IN ('meta', 'google', 'google_ads', 'linkedin', 'linkedin_ads', 'twitter', 'tiktok', 'other'));
...
ALTER TABLE platform_connections
  ...
  CHECK (platform IN ('meta', 'google', 'google_ads', 'linkedin', 'linkedin_ads', 'twitter', 'tiktok', 'shopify', 'other'));
